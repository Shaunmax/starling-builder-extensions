...
import starling.extensions.QuadSectionArc;
...
public class EmbeddedComponents extends Sprite {
    ...
    public static const linkers:Array = [ContainerButton, GradientQuad, Gauge, TextureMaskStyle, LightSource, LightStyle, PixelMaskDisplayObject, QuadSection, GodRayPlane, QuadSectionArc];
}
}
